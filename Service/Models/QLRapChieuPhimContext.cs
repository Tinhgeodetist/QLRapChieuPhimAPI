...
namespace Service.Models
{
    public partial class QLRapChieuPhimContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("name=QLRapChieuPhimConnect");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ThongTinGhe>(entity =>
            {
                entity.ToTable("ThongTinGhe");
                ...
                entity.Property(e => e.ViTriGheVip)
                    .IsRequired()
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasComment("Từ ghế bao nhiêu đến ghế bao nhiêu trong dãy ghế, vd: 10-16");

                entity.HasOne(d => d.LoaiGhe)
                    .WithMany(p => p.ThongTinGhes)
                    .HasForeignKey(d => d.LoaiGheId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ThongTinGhe_LoaiGhe");

                entity.HasOne(d => d.Phong)
                    .WithMany(p => p.ThongTinGhes)
                    .HasForeignKey(d => d.PhongId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ThongTinGhe_Phong");
            });
